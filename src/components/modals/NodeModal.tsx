        ...
        <div className="p-5 sm:p-6 flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-white/5 p-3 rounded-xl border border-white/10">
              <span className="text-white/60 block">Power Draw</span>
              <span className="text-sm font-bold text-white mt-0.5 block">{node.power}</span>
            </div>
            <div className="bg-white/5 p-3 rounded-xl border border-white/10">
              <span className="text-white/60 block">Temperature</span>
              <span className="text-sm font-bold text-white mt-0.5 block">{node.temp}</span>
            </div>
            <div className="bg-white/5 p-3 rounded-xl border border-white/10">
              <span className="text-white/60 block">Connected IoT Devices</span>
              <span className="text-sm font-bold text-white mt-0.5 block">{node.devices} Units</span>
            </div>
            <div className="bg-white/5 p-3 rounded-xl border border-white/10">
              <span className="text-white/60 block">Node Health</span>
