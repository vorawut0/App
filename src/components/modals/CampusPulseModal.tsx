  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/55 backdrop-blur-sm flex items-center justify-center p-2.5 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-[28px] max-w-3xl w-full shadow-2xl overflow-hidden border border-slate-100 flex flex-col max-h-[92vh] animate-scaleIn">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 bg-[#fbfbfe] space-y-6">
          {/* TAB 1: OVERVIEW */}
          {activeTab === 'overview' && (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-2xl font-bold text-[#121b2e]">86</span>
                  </div>
            ...
            <div className="space-y-4 animate-fadeIn">
              ...
              <div className="flex flex-col sm:flex-row gap-2.5">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <option value="all">ทุกกลุ่มสาระ (86 ท่าน)</option>
                ...
                {filteredFaculty.map((teacher) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      <button
                        onClick={() => alert(`ส่งคำขอเข้าพบอาจารย์ ${teacher.name} ในช่วง Office Hours เรียบร้อยแล้ว`)}
                      ...
                      <button
                        onClick={() => alert(`อีเมลติดต่อ: ${teacher.email}`)}
